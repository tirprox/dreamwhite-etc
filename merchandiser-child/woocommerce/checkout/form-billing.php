...
?>
	<div class="woocommerce-billing-fields">
		...
		<div class="woocommerce-billing-fields__field-wrapper">
			...
			$fields['billing_company']['priority'] = 110;
			...
			$fields['billing_country']['clear'] = false;
			$fields['billing_postcode']['clear'] = false;
			$fields['billing_city']['clear'] = false;
			$fields['billing_state']['clear'] = false;
			$fields['billing_address_1']['clear'] = false;
			
			
			$fields['billing_address_1']['placeholder'] = 'Адрес: улица, номер дома, квартира и пр.';
			
			$fields['billing_address_1']['class'][0] = "form-row-last";
